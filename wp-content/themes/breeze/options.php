	...
	$options[] = array(
		...
		$options[] = array(
			...
			$options[] = array(
				...
				'id' => 'footer_text',
				'std' => 'Copyright &copy; {year} · Theme design by the Bluth_admin Company · www.bluth_admin.is',
				'type' => 'textarea');
	...
	$options[] = array(
		...
		$options[] = array(
			...
			$options[] = array(
				...
				'desc' => __('Select what kind of ad you want added above the top menu. <a target="_blank" href="http://bluth_admin.is/wordpress/breeze/wp-content/uploads/2013/08/adspace_top.jpg">See Example</a>', 'bluth_admin'),
				'id' => 'ad_header_mode',
				'std' => 'none',
				'type' => 'radio',
				'options' => array(
			...
			$options[] = array(
				...
				'desc' => __('Here you can add advertising between posts. <a target="_blank" href="http://bluth_admin.is/wordpress/breeze/wp-content/uploads/2013/08/adspace_between.jpg">See Example</a>', 'bluth_admin'),
				'id' => 'ad_posts_mode',
				'std' => 'none',
				'type' => 'radio',
				'options' => array(
			...
			$options[] = array(
				...
				'desc' => __('Select what kind of ad you want added above the main container. <a target="_blank" href="http://bluth_admin.is/wordpress/breeze/wp-content/uploads/2013/08/adspace_above_content.jpg">See Example</a>', 'bluth_admin'),
				'id' => 'ad_content_mode',
				'std' => 'none',
				'type' => 'radio',
				'options' => array(
