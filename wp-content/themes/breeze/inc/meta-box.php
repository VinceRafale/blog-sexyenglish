<?php
	...
	function blu_format_gallery( $post )  {  
	    ...
	    <fieldset class="full">
		    ...
		    foreach( $blu_gallery as $key => $item ){ 
		    	...
		    	<?php /* ?>
				    <div class="array_item" data-key="<?php echo $key2; ?>" data-name="blu_review_field_text">
				    	<h4>Name</h4>
		    			<input data-arrayname="gallery_src" class="blu_item full" type="text" name="blu_review_field_text[<?php echo $key2; ?>][gallery_src]" value="<?php echo $item[$key2]['gallery_src']; ?>">
				    	<button type="button" class="close">&times;</button>
				    </div><?php */
				}
			} ?>
	...
	function blu_format_video( $post )  {  
	    ...
	    <fieldset class="clearfix blu_format blu_format_video"> 
		    <div class="cd-layout" style="width: 100%;"> 
		    	<input type="text" id="video-url" name="blu_video_url" value="<?php echo $video_url; ?>" placeholder="Video URL.." style="margin: 10px 0; width:100%; font-size: 22px;">
		    </div>
		</fieldset>
		<?php
	}
	function blu_format_audio( $post )  {  
	    ...
	    <fieldset class="clearfix blu_format blu_format_audio"> 
		    <div class="cd-layout" style="width: 100%;"> 
		    	<input type="text" id="audio-url" name="blu_audio_url" value="<?php echo $audio_url; ?>" placeholder="Audio URL.." style="margin: 10px 0; width:100%; font-size: 22px;">
		    </div>
		</fieldset>
		<?php
	}
	function blu_format_link( $post )  {  
	    ...
	    <fieldset class="clearfix blu_format blu_format_link"> 
		    <div class="cd-layout" style="width: 100%;"> 
		    	<input type="text" id="link-url" name="blu_link_url" value="<?php echo $link_url; ?>" placeholder="Link URL.." style="margin: 10px 0; width:100%; font-size: 22px;">
		    </div>
		</fieldset>
		<?php
	}
	function blu_format_quote( $post )  {  
	    ...
	    <fieldset class="clearfix blu_format blu_format_quote"> 
		    <div class="cd-layout" style="width: 100%;"> 
		    	<input type="text" id="quote-author" name="blu_quote_author" value="<?php echo $quote_author; ?>" placeholder="Quote Author Name.." style="margin: 10px 0; width:100%; font-size: 16px;">
		    </div>
		    <div class="cd-layout" style="width: 100%;"> 
		    	<input type="text" id="quote-src" name="blu_quote_src" value="<?php echo $quote_src; ?>" placeholder="Quote Source (URL).." style="margin: 10px 0; width:100%; font-size: 16px;">
		    </div>
		    <div class="cd-layout" style="width: 100%;"> 
		    	<textarea id="quote-text" name="blu_quote_text" value="" placeholder="Quote Text.." style="margin: 10px 0; width:100%; font-size: 16px;"><?php echo $quote_text; ?></textarea>
		    </div>
		</fieldset>
		<?php
	}
	...
	{  
	    ...
	    $dir = get_template_directory_uri().'/inc/admin/img/';  
	...
	{  
	    ...
	    <p> 
	        <input type="text" id="bluth_page_subtitle" name="bluth_page_subtitle" placeholder="Page Sub-title.." value="<?php echo $page_subtitle; ?>" style="margin: 10px 0; width:100%; font-size: 16px;" />  
	    </p>  
	    <p> 
