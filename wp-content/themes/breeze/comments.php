    ...
    if(of_get_option('enable_post_comments')){
        ...
        <div id="comments"><?php
          ...
          $args = array(
            ...
            'comment_field' =>  '<p class="comment-form-comment"><label for="comment">' . __( 'Comment', 'bluth' ) .
              '</label><div id="comment-textfield-area"><div id="image-comment-placeholder"></div><textarea id="comment" name="comment" cols="45" rows="5" aria-required="true">' .
            ...
            'fields' => apply_filters( 'comment_form_default_fields', array(
              ...
              'email' =>
                '<p class="comment-form-email"><label for="email">' . __( 'Email', 'bluth' ) . '</label> ' .
                ( $req ? '<span class="required">*</span>' : '' ) .
