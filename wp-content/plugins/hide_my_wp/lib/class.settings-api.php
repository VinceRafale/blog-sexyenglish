            ...
            if (is_network_admin())
               ...
               // do_settings_sections( $this->settings_menu['name']);
                ...
                <span style="padding:0 10px;" class="alignright">
                    <p class="submit">
                        <input name="reset-defaults" onclick="return confirm('<?php _e('Are you sure you want to restore all settings back to their default values?', $this->settings_menu['name']); ?>');" class="button-secondary" type="submit" value="<?php _e('Reset Defaults', $this->settings_menu['name']); ?>" />                      </p>
                </span> 
