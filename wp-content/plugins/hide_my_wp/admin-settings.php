        ...
        $fields['permalink'] = array(
                    array(
                     ...
                     array(
                        ...
                        'desc' => __( 'Remove comments and WP details. (Require new style path)(Use with cache!).', self::slug ),
                        'type' => 'select',
                        'default' => '',
                        'class' =>'permalink_req' ,
                        'options' => array(
        ...
        $fields['general'] = 
                array(
                        ...
                        array(
                            ...
                            'desc' => __( 'Choose this option only if you have a customized htaccess and don\'t want to allow HMWP update it frequently. Instead you need to configure HMWP manually <a href="?page='.self::slug.'&single_config=1">Click here</a>  and go to Start tab.', self::slug ),
                            'type' => 'checkbox',
                            'default' => '',
                            'class' =>''
                            )
                        ...
                        array(
                         ...
                         array(
                            ...
                            'type' => 'textarea',
                            'default' => 'index.php, wp-content/repair.php, wp-comments-post.php, wp-includes/js/tinymce/wp-tinymce.php, xmlrpc.php',
